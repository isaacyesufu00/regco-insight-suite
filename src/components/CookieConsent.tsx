...
const CookieConsent = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[90] bg-foregroundv className="container mx-auto px-4 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
        <p className="text-sm text-foreground text-center backext-left leading-relaxed">
