...
const Dashboard = () => {
  ...
  const [stats, setStats] = useState<UserStats>({ on_time_rate: 0, violations: 0 });
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const { data: statsData } = await supabase
        .from("user_stats")
        .select("on_time_rate, violations")
        .eq("user_id", user.id)
        .maybeSingle();
      ...
      <div className="max-w-6xl mx-auto px-6 pb-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-5">
          ...
          <div className="lg:col-span-2 rounded-2xl p-6" style={{ background: "#ffffff", border: "1px solid #e8ecf4" }}>
            <h3 className="text-sm font-semibold mb-4" style={{ color: "#8a8a9a", textTransform: "uppercase", letterSpacing: "0.05em" }}>
              Report Status
            </h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
          <div className="rounded-2xl p-6 flex items-center gap-4" style={{ background: "#ffffff", border: "1px solid #e8ecf4" }}>
            ...
            <div>
              <p className="text-2xl font-bold" style={{ color: "#1a1a2e" }}>{reportCount}</p>
